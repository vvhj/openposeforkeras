...
dataset_dir = 'F:/ArtificialIntelligence/dataset/CoCo'
...
dataset_dir_h5 = 'D:/big3down/coco2017data'

tr_hdf5_path = os.path.join(dataset_dir_h5, "coco_train_dataset.h5")
val_hdf5_path = os.path.join(dataset_dir_h5, "coco_val_dataset.h5")
